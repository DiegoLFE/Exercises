...
public class Ejercicio3 {
    ...
    public Double promedio(ArrayList<Integer> unArrayDeEnteros){
        ...
        //Acumulo el valor de la suma en un decimal, para que al dividir la cuenta pueda ser decimal.
        Double acumuladorSuma = 0.0;

        //Recorro el array y voy sumando el valor de su contenido.
        for(Integer i = 0; i < unArrayDeEnteros.size() ; i++){
            acumuladorSuma = acumuladorSuma + unArrayDeEnteros.get(i);
        }

        //Devuelvo el promedio
        return acumuladorSuma/unArrayDeEnteros.size();
    }

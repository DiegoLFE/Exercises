...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView = (RecyclerView) findViewById(R.id.listViewPersonajes);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Obtengo la posicion del recyclerView
                Integer position = recyclerView.getChildAdapterPosition(view);
                // Obtengo el dato del adapter.
                // Forma 1
                Personaje miPersonaje = miAdapter.getItem(position);
                // Forma 2
                miPersonaje = ((MiAdaptadorDePersonajes)recyclerView.getAdapter()).getItem(position);
                // Uso los datos
                Snackbar.make(view, miPersonaje.getNombre(), Snackbar.LENGTH_SHORT).show();
            }
        };

        // Le paso el listener al adapter
        miAdapter.setListener(listener);
